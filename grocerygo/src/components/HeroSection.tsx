  ...
  const slides = [
    {
      ...
      btnText: "Shop Now",
      bg: "https://images.unsplash.com/photo-1706267701238-b4d69fc8f640?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjg4fHxGcmVzaCUyMG9yZ2FuaWMlMjBncm9jZXJpZXN8ZW58MHx8MHx8fDA%3D"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      subtitle: "Easy and seamleass online grocery shopping experience.",
      btnText: "Get Started",
      ...
      <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6'>
        ...
        >
          ...
          <motion.button
            ...
            className='mt-4 bg-white text-green-700 hover:bg-green-200 px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 flex items-center gap-2'
          >
            <ShoppingBasket />
