  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-white'>
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-green-700">GroceryGo</h1>
      ...
      transition={{
        ...
        Your one-stop destination for fresh groceries, fast delivery, and everyday essentials.
      </motion.p>
      <motion.div
      initial={{
        opacity:0,
      ...
      >
        ...
        <BikeIcon className='w-24 h-24 md:h-32 text-orange-500 drop-shadow-md' />
